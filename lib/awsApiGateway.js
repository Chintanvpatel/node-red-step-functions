...
var awsApiGateway = {
  ...
  create: function (gatewayJson, restApiId, brandId, appId, appname, s3BucketName) {
    console.log(gatewayJson)
    return when.promise(function (resolve, reject) {
      console.log('Saving API Definition..')
      saveApiDefinition(gatewayJson, s3BucketName, brandId, appId, appname).then(data => {
...
var saveApiDefinition = function (definition, s3BucketName, brandId, appId, appname) {
  return when.promise(function (resolve, reject) {
    var params = {}
