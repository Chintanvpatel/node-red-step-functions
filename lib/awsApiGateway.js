...
var awsApiGateway = {
  ...
  create: function (gatewayJson, restApiId, brandId, appId, s3BucketName) {
    console.log(gatewayJson)
    return when.promise(function (resolve, reject) {
      console.log('Saving API Definition..')
      saveApiDefinition(gatewayJson, s3BucketName, brandId, appId).then(data => {
...
var saveApiDefinition = function (definition, s3BucketName, brandId, appId) {
  return when.promise(function (resolve, reject) {
    var params = {}
    params.Bucket = s3BucketName
    params.Key = brandId + '/' + appId + '/' + '/api_definition.json'
